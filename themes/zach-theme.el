...
(def-doom-theme zach
  "Zach's custom theme for doom emacs"
  ...
  ;;  (dark-cyan  '("#5699AF" "#5699AF" "cyan"         ))
   ...
   (grey       base4)
   ;; (red        '("#ffffff" "#ff6655" "red"          ))
   (red        '("#ef596f" "#ff6655" "red"          ))
   ;; (orange     '("#da8548" "#dd8844" "brightred"    ))

   (orange     '("#d19a66" "#dd8844" "brightred"    ))
   (green      '("#89ca78" "#99bb66" "green"        ))
   (teal       '("#2bbac5" "#44b9b1" "brightgreen"  ))
   (yellow     '("#ECBE7B" "#ECBE7B" "yellow"       ))
   (blue       '("#51afef" "#51afef" "brightblue"   ))
   (dark-blue  '("#2257A0" "#2257A0" "blue"         ))
   (magenta    '("#d55fde" "#c678dd" "brightmagenta"))
   ;; (violet     '("#a9a1e1" "#a9a1e1" "magenta"      ))
   (violet     '("#a9a1e1" "#a9a1e1" "magenta"      ))
   (cyan       '("#46D9FF" "#46D9FF" "brightcyan"   ))
   (dark-cyan  '("#5699AF" "#5699AF" "cyan"         ))
...
;;; doom-one-theme.el ends here;; zaiste-theme.el
